...
# Loading pre-trained models for facial expression recognition
facec = cv2.CascadeClassifier('haarcascade_frontalface_default.xml')
model = FacialExpressionModel("Facialmodel_a1.json","Facialmodel_weights1.h5")
...
#Function to capture frames through front camera and detect emotion in real-time
def realTimeCapture():
...
#Function to click an image and then store in into a path
def captureImage():
    cam_port = 0
...
upload2 = Button(top, text="Real Time Video", command=realTimeCapture, padx=10, pady=5)
